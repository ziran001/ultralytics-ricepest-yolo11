...
class C3k2CSE(C3k2):
    ...
    def __init__(
        ...
        """
        # Keep the latest Ultralytics C3k2 argument order (``attn`` was
        # inserted before ``groups`` in 8.4.x).  The custom CSE block uses
        # its own channel/spatial attention below, so the base ``attn`` flag
